...
from udb.core.model import DhcpRecord, DnsRecord, DnsZone, Message, Search, Subnet, User
...
class SearchTest(WebCase):
    ...
    def test_search_messages(self):
        ...
        self.assertEqual(
            ['147.87.250.0/24 (DMZ)', 'bfh.ch', 'foo.bfh.ch = 147.87.250.0(A)'], sorted([o.summary for o in obj_list])
        )
